...
document
    ...
    .addEventListener("change", function(){
        if(this.files.length > 0){
            document.getElementById("encryptFileName").innerText =this.files[0].name;
        }
    });
...
document
    ...
    .addEventListener("change", function(){
        if(this.files.length > 0){
            document.getElementById("decryptFileName").innerText = this.files[0].name;
        }
    });



const encKey = document.getElementById("enc_key");
...
const decKey = document.getElementById("dec_key");
...
function generateKey() {
    ...
    const keyInput = document.getElementById("enc_key");
    keyInput.value = key;

    document.getElementById("encCounter").innerHTML = "✔";
}
